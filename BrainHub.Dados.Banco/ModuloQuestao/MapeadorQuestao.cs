...
namespace BrainHub.Dados.Banco.ModuloQuestao
{
     public class MapeadorQuestao : MapeadorBase<Questao>
     {
        ...
        public Alternativa ConverterRegistroAlternativas(Questao questao,SqlDataReader leitor)
        {
            ...
            Alternativa alternativa = new Alternativa(id_alternativa, tituloresposta, letraalternativa, alternativacorreta, questao);
            return alternativa;
        }
    }
}
